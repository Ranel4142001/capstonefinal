...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
            ...
            <ul class="collapse list-unstyled" id="manageProductsSubmenu">
                 <li>
                    <a href="<?php echo $base_url_path; ?>/views/inventory.php" class="sidebar-link submenu-link">
                        <i class="fas fa-plus-square"></i> Inventory
                    </a>
                </li>
                <li>
        ...
        <li><a href="<?php echo $base_url_path; ?>/views/reports/stock_report.php" class="sidebar-link"><i class="fas fa-warehouse"></i> Stock Report</a></li>
